...
public class RPC
{
        ...
        public static Map getBindingInfo(String ac, RemoteProfile remoteProfile)
                ...
                try {
                        ...
                        if (map instanceof Map) {
                                return extractBindingResult((Map) map);
                        }
                        ...
                        return handleLastBindingInfo(remoteProfile);
                } catch (RPCException e) {
                        return handleLastBindingInfo(remoteProfile, e);
                }
        }

        @SuppressWarnings("rawtypes")
        private static Map extractBindingResult(Map map) {
        ...
        private static Map handleLastBindingInfo(RemoteProfile remoteProfile) {
                return handleLastBindingInfo(remoteProfile, null);
        }

        private static Map handleLastBindingInfo(RemoteProfile remoteProfile,
                        RPCException e) throws RPCException {
